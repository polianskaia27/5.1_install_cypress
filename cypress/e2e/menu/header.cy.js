...
it("change language to Ukranian", () => {
  ...
  cy.chekTheElement("#header-tabs > li:nth-child(4) > a > span", "Українська");
  cy.checkUrl("/?page=1&sort=id,asc");
});
...
it("navigate to Password page and verify title", () => {
  cy.getToThePage("#account-menu > a", "#account-menu > div > a:nth-child(2)");
...
it("navigate to Sing Out page and verify title", () => {
  cy.getToThePage("#account-menu > a", "#account-menu > div > a:nth-child(3)");
  cy.chekTheElement(
