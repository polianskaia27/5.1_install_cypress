...
describe("Checking of menu", () => {
  ...
  it.skip("change language to English", () => {
    cy.getToThePage(
      "#header-tabs > li:nth-child(4) > a",
  ...
  it.skip("change language to Russian", () => {
    cy.getToThePage(
      "#header-tabs > li:nth-child(4) > a",
  ...
  it.skip("change language to Ukranian", () => {
    cy.getToThePage(
      "#header-tabs > li:nth-child(4) > a",
  ...
  it.skip("navigate to Settings page and verify title", () => {
    cy.getToThePage(
      "#account-menu > a",
  ...
  it.skip("navigate to Password page and verify title", () => {
    cy.getToThePage(
      "#account-menu > a",
  ...
  it.skip("navigate to Sing Out page and verify title", () => {
    cy.getToThePage(
      "#account-menu > a",
